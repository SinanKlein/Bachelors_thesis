...
# USER: fill these in
# ---------------------------------------------------------------------------
RAW_DATA_DIR = Path(r"C:\Sinan_Klein\LMU\lmu_thesis\multimodal_network\data\splits_unified_GvHD")    # folder containing graph_data.npz
