...
import sys as _sys0
_sys0.path.insert(0, str(Path(__file__).resolve().parent))
from paths import COHORT, COHORT_DIR              # noqa: E402
BASE = COHORT_DIR
...
W_FILES = [
    BASE / "Networks" / "Bipartite_edge_probability" / "glasso"
         / f"{COHORT}_glasso_edge_probability_bacteria_virus_stars01.csv.gz",
    BASE / "Networks" / "Bipartite_edge_probability" / "glasso"
